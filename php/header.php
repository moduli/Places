...
<ul id="nav">
	<li id="addbuttonli"><a id="addbutton" href="javascript:void(0)" onclick="toggleAddMode();">Add Entry</a></li>
	...
	<li id="okbuttonli"><a id="okbutton" href="javascript:void(0)" onclick="confirmNew();">OK</a></li>
